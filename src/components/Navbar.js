        ...
        <div className="container mx-auto">
          <div className="navbar-start py-0">
            <Link to="/" className="font-bold text-xl md:ml-0">
              <img
                className="w-40 md:w-48 h-11 md:h-12"
                src={emon}
                alt="Emon"
              />
            </Link>
          ...
          <div className="navbar navbar-end">
            <a
              className="p-2 rounded-full bg-accent hover:bg-info text-secondary mr-2"
            ...
            <a
              ...
              className="p-2 rounded-full bg-accent hover:bg-info text-secondary"
              target="_blank"
              rel="noreferrer"
            >
