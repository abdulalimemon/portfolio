...
const MobileMenu = () => {
  ...
  return (
    <div className="lg:hidden">
      ...
      <div
        className={`top-0 right-0 w-10/12  py-5 px-10 bg-base-100 fixed h-screen min-h-screen z-50 overflow-y-auto ease-in-out duration-500 ${
          ...
          <div className="space-y-10 flex items-center justify-center flex-col">
            <div className="flex items-center justify-center">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? "text-secondary font-bold mr-2 flex items-center text-lg border-b-2 border-neutral"
                    : "text-neutral font-bold mr-2 flex items-center text-lg"
                }
              >
                {" "}
                Home
