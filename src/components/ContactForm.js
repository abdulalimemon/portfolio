            ...
            <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-5 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32">
                <div className="flex flex-col justify-between">
                    <div className="space-y-2">
                        <h2 className="text-4xl md:text-4xl font-bold leading-tight lg:text-5xl text-transparent bg-clip-text bg-gradient-to-r from-[#FFCD38] to-[#FF8D29] pb-2">Let's get in touch!</h2>
                        <div className="text-white py-5 lg:pr-10">
                            <p className='text-neutral text-sm lg:text-base'>If you have any questions or suggestions regarding any projects, please don't hesitate to contact me. To contact me, fill out the contact form or you can reach out to me via email. I will do my best to respond to your inquiry as soon as possible.</p>
                        </div>
                        <div className='pb-10'>
                            <div className="space-y-4">
                                ...
                                <p className="flex items-center">
                                    ...
                                    <span className='text-neutral'>abdulalimemon11@gmail.com</span>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <form ref={form} className="space-y-3" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="input text-neutral input-bordered text-sm w-full p-3 outline-none rounded bg-gray-800 hover:bg-gray-800 mt-2" placeholder="Enter your email."
                    ...
                    <div>
                        <label htmlFor="subject" className="text-sm text-neutral">Subject</label>
                        <input
                    ...
                    <div>
                        <label htmlFor="message" className="text-sm text-neutral">Message</label>
